...
BLOG_AUTHOR = "Pete"  # (translatable)
BLOG_TITLE = "Exploding Comma"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://explodingcomma.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://explodingcomma.com/"
BLOG_EMAIL = "pete@explodingcomma.com"
BLOG_DESCRIPTION = "Super duper excellence"  # (translatable)
